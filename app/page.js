...
import { Star, ShoppingCart, Menu, X, ChevronDown, Shield, Calendar, Leaf, Clock, CheckCircle, Users, MessageCircle, Award, Truck, CreditCard, Lock } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button className="hidden md:block bg-[#FF8C00] text-white px-6 py-2 rounded-full hover:bg-[#D2691E] transition-all">
                Get 20% Off
              </Button>
              <button
                className="md:hidden"
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-4 py-4 border-t">
              <div className="flex flex-col space-y-4">
                ...
                <a href="#about" className="text-gray-700 hover:text-[#D2691E] transition-colors">About</a>
                <a href="#contact" className="text-gray-700 hover:text-[#D2691E] transition-colors">Contact</a>
                <Button className="bg-[#FF8C00] text-white px-6 py-2 rounded-full hover:bg-[#D2691E] transition-all">
                  Get 20% Off
                </Button>
              </div>
            </div>
