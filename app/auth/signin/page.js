      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/">
            ...
            <p className="text-gray-600">India's First Helmet Deodorant</p>
          </Link>
        </div>
        ...
        <Card className="w-full shadow-2xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>Sign in to your Hygena account</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/auth/signup" className="font-medium text-[#D2691E] hover:underline">
                  Sign up
                </Link>
              </p>
            </div>
