...
// Load Cart & Session Data
  ...
  const applyCoupon = (code = null) => {
    ...
    if (codeToApply === 'FRESH10') {
      const coupon = { code: 'FRESH10', discount: 10 }
            ...
            <CardContent className="space-y-4">
              ...
              {appliedCoupon ? (
                ...
                <div className="space-y-3 pt-2 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={() => setShowCouponInput(!showCouponInput)} className="flex items-center gap-1 text-sm font-semibold text-[#D2691E]">
                      1 offer <ChevronRight className="w-4 h-4" />
                    </button>
                  </div>
                  {showCouponInput && (
                    <div className="p-4 bg-white rounded-lg border border-gray-200 space-y-3">
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#D2691E]"
                        />
                        <button onClick={() => applyCoupon()} className="px-4 py-2 bg-black text-white rounded-lg text-sm font-semibold">
                          SUBMIT
                        </button>
                      </div>
                      ...
                      <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                        ...
                        <button onClick={() => applyCoupon('FRESH10')} className="text-xs text-green-700 font-semibold underline">
                          APPLY
                        </button>
                      </div>
                    </div>
              ...
              {discount > 0 && (
                <div className="bg-green-50 p-2 rounded text-center">
                  <p className="text-xs text-green-700 font-medium">🎉 You saved ₹{discount}!</p>
                </div>
              )}
            </CardContent>
            <CardFooter className="bg-gray-50 p-4">
              <p className="text-xs text-gray-500 text-center w-full">Secure Checkout • 30-Day Returns</p>
            </CardFooter>
          </Card>
        </div>
      </div>
